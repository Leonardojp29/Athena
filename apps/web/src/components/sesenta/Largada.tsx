...
/* Un segundo por número: tres, dos, uno y a jugar, como la salida de una carrera. */
const PASO_MS = 1000;
 ...
 * La largada.
 *
 * Existe porque el reloj es uno solo y global: entrar de golpe y encontrarlo ya corriendo sería
 * regalar los primeros segundos. Acá se sabe exactamente cuándo empieza a contar.
 */
      ...
      <div className="relative grid size-40 place-items-center">
        <svg viewBox="0 0 100 100" className="absolute inset-0 size-full -rotate-90" aria-hidden="true">
          ...
          <circle
            ...
            pathLength="1"
            strokeDasharray="1"
            className="animate-sesenta-aro text-primary-ink"
          />
        </svg>
        <p
          key={paso}
          className="animate-sesenta-largada font-display text-6xl font-semibold uppercase tabular tracking-label"
        >
          {paso === 0 ? 'Ya' : paso}
        </p>
      </div>
