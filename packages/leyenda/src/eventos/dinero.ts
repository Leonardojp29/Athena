    ...
    opciones: [
      {
        ...
        resultado: 'Fue una mano en el área que nadie entendió. Ni vos.',
      },
      {
        id: 'cortar',
    ...
    opciones: [
      {
        ...
        riesgo: {
          ...
          relatoBien: 'Salió. En dos años valía cuatro veces lo que pusiste.',
    ...
    opciones: [
      ...
      },
      {
        ...
        riesgo: {
          ...
          relatoBien: 'Cerraron en quince y quedaron mejor que antes.',
    ...
    opciones: [
      ...
      },
      {
        ...
        riesgo: {
          ...
          relatoBien: 'Cuatro años después ganaste y hasta te devolvieron parte.',
      ...
      },
      {
        ...
        riesgo: {
          ...
          relatoBien: 'Prescribió. Nunca supiste bien por qué.',
